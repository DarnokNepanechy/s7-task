...
В качестве базы данных я использовал H2. Язык - Java 17. Сборщик проектов - Maven. Используемые зависимости: Spring Boot, Web, Security, Data JPA, Java JWT, Lombok. При запуске класс S7TaskApplication добавит в БД четыре тестовых пользователя. У авторизованых пользователей есть две роли: **ROLE_ADMIN** и **ROLE_USER**, а так же для всех неавторизованных пользователей доступна **регистрация** и **авторизация**.
